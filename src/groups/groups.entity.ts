...
export class Group {
  @ApiProperty({
    example: 'c37ac5df-a637-4663-aa4a-2731302caef2',
  ...
  @ApiProperty({
    ...
    description: 'Name of the Group (not unique)',
  })
  ...
  @ApiProperty({
    type: () => User,
    example: '{...owner information}',
    description: 'json data of the owner',
  })
  ...
  @ApiProperty({
    example: '[{uuid:...}, {uuid: ...}...]',
    description: 'list of the information about group memebers',
  })
